...
//? Taken the below code from (orderTracker)[https://pub.dev/packages/order_tracker]
//? It had a lots of issue which are fixed by me
class OrderTracker extends StatefulWidget {
  ...
  final List<TextDto>? outForDeliveryTitleAndDateList;
  ...
  /// This provides dateTime value beside the order Placed title.
  final String? orderPlacedDateAndTime;

  /// This provides dateTime value beside the shipped title.
  final String? shippedDateAndTime;

  /// This provides dateTime value beside the Out for delivery title.
  final String? outForDeliveryDateAndTime;

  /// This provides dateTime value beside the Delivered title.
  final String? deliveredDateAndTime;
  ...
  const OrderTracker({
    ...
    this.outForDeliveryTitleAndDateList,
    ...
    this.orderPlacedDateAndTime,
    this.shippedDateAndTime,
    this.outForDeliveryDateAndTime,
    this.deliveredDateAndTime,
  }) : super(key: key);
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: SizedBox(
                    width: 2,
                    height: widget.outForDeliveryTitleAndDateList != null &&
                            widget.outForDeliveryTitleAndDateList!.isNotEmpty
                        ? widget.outForDeliveryTitleAndDateList!.length * 56
                        : 20,
                    child: RotatedBox(
                      quarterTurns: 1,
                      child: LinearProgressIndicator(
                ...
                Expanded(
                  child: ListView.separated(
                      ...
                      itemCount: widget.outForDeliveryTitleAndDateList !=
                                  null &&
                              widget.outForDeliveryTitleAndDateList!.isNotEmpty
                          ? widget.outForDeliveryTitleAndDateList!.length
                          : 0),
                )
              ],
            ),
                      ...
                      TextSpan(
                          ...
                          style: widget.headingTitleStyle ??
                              const TextStyle(
                                  fontSize: 16, fontWeight: FontWeight.bold)),
                      TextSpan(
                        text: widget.deliveredDateAndTime ?? '',
                        style: widget.headingDateTextStyle ??
                            const TextStyle(fontSize: 16, color: Colors.grey),
                      ),
                    ],
